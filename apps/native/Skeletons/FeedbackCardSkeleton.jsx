    ...
    <View className="p-[0_0_0_10px] mt-[5px] mb-[18px] w-[100%]">
      <View className="relative w-[100%] h-fit p-1 w-full">
        ...
        <View className="bg-white shadow rounded-md p-6 flex flex-col w-full">
          <View className="font-[roboto-bold] text-[15px] bg-gray-200 h-[20px] w-[60%] mb-2 rounded-md" />
          ...
          <Text className="leading-[22px] font-[roboto] text-[16px] mt-1 bg-gray-200 h-[80px] rounded-md" />
        </View>
      </View>
    </View>
  );
